      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="px-[18px] pb-7 pt-4">
            {/* Balance card */}
            <div className="rounded-card p-5 mb-4 text-white border-none" style={{ background: 'linear-gradient(135deg, #084f49, #0d7a72)' }}>
              <div className="text-[13px] font-bold text-white/75">Available balance</div>
              <div className="text-[32px] font-extrabold tracking-[-0.02em] my-1 mb-3.5">₦248,500</div>
